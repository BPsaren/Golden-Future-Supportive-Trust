        ...
        <table style={{ borderCollapse: "collapse", width: "100%" }}>
          <thead>
            <tr style={{ backgroundColor: "#f2f2f2" }}>
              ...
              <th style={{ padding: "12px", textAlign: "left" }}>Starting Loan for Business</th>
              <th style={{ padding: "12px", textAlign: "left" }}>Total Loan for Business</th>
            ...
            {filteredUsers.map((curUser) => (
              <tr key={curUser._id} style={{ borderBottom: "1px solid #ddd" }}>
                ...
                <td style={{ padding: "12px", textAlign: "left" }}>
                  <Link to={`/admin/transactioninvestnhistory/${curUser.account_no}/investdatafetch`} style={{ marginRight: "8px" }}>
                    {curUser.account_no}
                  </Link>
                </td>
